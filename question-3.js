...
// ใช้ Built-in Array Function (Map, Filter หรือ Reduce)
const findName = (array) => {
  return array.map((item) => item.name);
};

const getCharOverlimit = (array, charLimit) => {
  return array.filter((item) => {return item.split("").length > charLimit})
};

const nameUsers = findName(usersData);
console.log(nameUsers);

const nameCharOverlimit = getCharOverlimit(nameUsers, 17)
console.log(nameCharOverlimit);
